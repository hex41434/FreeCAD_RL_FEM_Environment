...
class my_rl_env():
    def __init__(self, save_path,loaded_mesh_path,loaded_mesh_filename,view_meshes,xls_pth,xls_filename,load_3d=True):
        ...
        self.loaded_mesh_path = loaded_mesh_path
        self.loaded_mesh_filename = loaded_mesh_filename
        self.load_3d = load_3d
        
        self.xls_pth = xls_pth
